...
public class CausalSelfAttention {
    ...
    public AbstractTensor forward(
        ...
        try (
            ...
            // Hook for subclasses to apply transformations after projection (e.g., QK normalization)
            postProjectionHook(queryBatch, tmpKeyBatch, tmpValBatch);
    ...
    /**
     * Hook for subclasses to apply transformations after Q/K/V projection and bias,
     * but before KV cache storage and RoPE.
     * Used by Gemma4Attention to apply QK normalization.
     */
